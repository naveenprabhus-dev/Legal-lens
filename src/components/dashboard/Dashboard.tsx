  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-8 border-b border-slate-200">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs px-2.5 py-0.5 rounded-full bg-emerald-50 text-emerald-800 border border-emerald-200 font-medium flex items-center gap-1">
      ...
      {loadingWorkspaces ? (
        ...
        /* Empty State for first time users (Section 11) */
        <div className="bg-white rounded-2xl border border-dashed border-slate-300 p-12 text-center max-w-2xl mx-auto shadow-2xs">
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3">
            <button
              ...
              onClick={() => setIsModalOpen(true)}
              className="px-6 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-medium shadow-xs hover:shadow-sm transition-all flex items-center gap-2"
            >
              ...
              <div className="mt-5 pt-4 border-t border-slate-100 flex items-center justify-between">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg bg-indigo-50 hover:bg-indigo-100 text-indigo-700 text-xs font-medium flex items-center gap-1 transition-colors"
                  >
                    <span>Open</span>
            ...
            <form onSubmit={handleCreate} className="space-y-4">
              ...
              <div className="pt-3 border-t border-slate-100 flex justify-end gap-2">
                ...
                <button
                  ...
                  className="px-5 py-2 text-xs rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-medium shadow-xs disabled:opacity-50"
                >
