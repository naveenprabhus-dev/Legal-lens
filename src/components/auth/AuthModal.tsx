...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl max-w-md w-full border border-slate-200 shadow-xl p-8 relative">
        <button
          id="close-auth-modal-btn"
          onClick={onClose}
          disabled={isSigningIn}
          className="absolute top-4 right-4 text-slate-600 hover:text-slate-600 p-1.5 rounded-lg focus:outline-hidden focus:ring-2 focus:ring-indigo-300"
        ...
        <div className="text-center">
          ...
          {/* Error notice */}
          {error && (
            <div className="mt-4 p-3 rounded-xl bg-rose-50 border border-rose-200 text-rose-800 text-xs flex items-start gap-2 text-left">
